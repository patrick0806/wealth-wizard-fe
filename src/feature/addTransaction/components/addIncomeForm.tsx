...
const INCOME_CATEGORIES = [
    { label: 'Salário', value: 'SALARY' },
    { label: 'Freelas', value: 'FREELANCE' },
]
type AddExpenseFormProps = {
    setOpen: React.Dispatch<React.SetStateAction<boolean>>
}

export function AddIncomeForm({ setOpen }: AddExpenseFormProps) {
    ...
    const onSubimit = async (data: z.infer<typeof IncomeFormSchema>) => {
        setIsSubmitting(true)
        try {
            console.log(data);
            setOpen(false);
            toast({
                title: 'Renda salva com sucesso',
                                        ...
                                        <FormControl >
                                            ...
                                            >
                                                {field.value ? (
                                                    ...
                                                    <span>Selecione a data da renda</span>
                                                )}
